...
function alterar(cpf){
    ...
    for(let i = 0; i < clientes.length; i++){
        ...
        if (cliente.cpf == cpf){
            ...
            document.getElementById("idadePB").value = cliente.idadePB
...
function salvar(){
    ...
    let idadePB = document.getElementById("idadePB").value
    ...
    if (clienteAlterado == null){
        ...
        clienteAlterado.idadePB = idadePB
...
function limparForm(){
    ...
    document.getElementById("idadePB").value = ""
